...
class FEPrescribedNormalDisplacement(FEPrescribedSurface):
    ...
    xml_section: str = field(init=False, default='Constraints')

@dataclass
class FESymmetryPlane(FESurfaceConstraint):
    laugon: Optional[Any] = field(default=None, metadata={'fe_name': 'laugon'})
    tol: Optional[Any] = field(default=None, metadata={'fe_name': 'tol'})
    penalty: Optional[Any] = field(default=None, metadata={'fe_name': 'penalty'})
    rhs: Optional[Any] = field(default=None, metadata={'fe_name': 'rhs'})
    minaug: Optional[Any] = field(default=None, metadata={'fe_name': 'minaug'})
    maxaug: Optional[Any] = field(default=None, metadata={'fe_name': 'maxaug'})
